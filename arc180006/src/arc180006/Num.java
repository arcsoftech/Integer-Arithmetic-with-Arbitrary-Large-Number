...
/**
 * class Num to store Big Numbers
 */
public class Num implements Comparable<Num> {
    ...
    /**
     * storing the number as an array in out Num class
     */
    private void storeNum()
    {
        this.arr = new long[this.list.size()];

        int count = 0 ;
        for(long elm : this.list)
        {
            this.arr[count] = elm;
            ++count;
        }
    ...
    /**
     * Convert given long integer to long array with provided base
     *
...
//        	}
     ...
     * no unary minus operator
     *
     * @param qt - Expression as String Queue
     * @return - Integer of type Num
     */
    ...
    public static void main(String[] args) {
        ...
        e = squareRoot(new Num("1524138393612345678876543212345678987654321234567876543223456787654323456787654321345678765434567654323456787654324567887654334567876543234678989989887654321212122"));
